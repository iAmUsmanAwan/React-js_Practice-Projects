        ...
        <header className="shadow sticky z-50 top-0">
            <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    {/* this link tag is alternate to <a href> beacuse link does not takes to another page but to router path, it can be self closing or in pair */}
                        <img
                            ...
                            <li>
                                ...
                                to="/" 
                                    className={({isActive}) =>
                                        ...
                                        //? here NavLink helps us to tell on the page which page we are on, by calling a call back function. isActive need to be extracted as {isActive}
                                    }
                                >
                                    Home
                                </NavLink>
