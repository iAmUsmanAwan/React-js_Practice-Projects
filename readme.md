...
### 🔗 Live Demo: [View on Netlify](https://todo-redux-state.netlify.app/)


## 11. Custom Hook: `useCounter` 🚀
...
Features:
Flexible Initial Value: Defaults to 0 but can be customized.
Increment Function: Increases the count by 1.
Decrement Function: Decreases the count by 1.
Reset Function: Resets the count to the initial value.
